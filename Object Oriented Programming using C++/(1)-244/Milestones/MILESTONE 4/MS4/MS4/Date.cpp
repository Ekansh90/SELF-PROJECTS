...
namespace sdds {
    ...
    // MODIFIED - returns current system year - 2021 for sem
    ...
    // MODIFIED - sets the members to values of current date
    ...
    std::istream& Date::read(std::istream& is)
    {
        ...
        if (is.fail())
        {
            errCode(CIN_FAILED);
            is.clear();
            // \n missing ? because here , we clear the failed state 
