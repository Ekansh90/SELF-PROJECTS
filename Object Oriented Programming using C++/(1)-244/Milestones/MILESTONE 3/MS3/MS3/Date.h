...
namespace sdds {
    ...
    private:
        ...
        /* validates the date ,setting the error code ,and then returning the result
    ...
    // EXTERN introduces a variable and makes it global throughout the namespace
    // we need to define it again , extern is making a global prototype only
